...
function Character(options) {
  ...
  this.life = 100;
  this.weapon = sword;
  this.getWeapon = function (weapon, power) {
    this.weapon = new Weapon ({name: name, power: power})
  }
  this.attack = function (monster, weapon){
...
function Monster(options) {
  ...
  this.attack = function (character, monsterAttack){
